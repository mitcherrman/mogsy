...
export const Routes = {
  ...
  LeagueSwipeHub: lazyWithRetry(() => import("@/pages/LeagueSwipeHub")),
  LeagueSwipeGame: lazyWithRetry(() => import("@/pages/LeagueSwipeGame")),
  LeagueSwipeStats: lazyWithRetry(() => import("@/pages/LeagueSwipeStats")),
  LolTierList: lazyWithRetry(() => import("@/pages/LolTierList")),
  LolDevChangelog: lazyWithRetry(() => import("@/pages/LolDevChangelog")),
  ItemDetail: lazyWithRetry(() => import("@/pages/items/ItemDetail")),
  LeagueDocsLanding: lazyWithRetry(() => import("@/pages/lol-docs/LeagueDocsLanding")),
  LeagueDocsChampionIndex: lazyWithRetry(() => import("@/pages/lol-docs/LeagueDocsChampionIndex")),
  LeagueDocsChampionDetail: lazyWithRetry(() => import("@/pages/lol-docs/LeagueDocsChampionDetail")),
  LeagueDocsProData: lazyWithRetry(() => import("@/pages/lol-docs/LeagueDocsProData")),
  LeagueDocsProYear: lazyWithRetry(() => import("@/pages/lol-docs/LeagueDocsProYear")),
  LeagueDocsProChampionIndex: lazyWithRetry(() => import("@/pages/lol-docs/LeagueDocsProChampionIndex")),
  LeagueDocsProChampionDetail: lazyWithRetry(() => import("@/pages/lol-docs/LeagueDocsProChampionDetail")),
  ProRosterLanding: lazyWithRetry(() => import("@/pages/lol-docs/pro-roster/ProRosterLanding")),
  ProRosterPlayers: lazyWithRetry(() => import("@/pages/lol-docs/pro-roster/ProRosterPlayers")),
  ProRosterPlayerProfile: lazyWithRetry(() => import("@/pages/lol-docs/pro-roster/ProRosterPlayerProfile")),
  ProRosterTeams: lazyWithRetry(() => import("@/pages/lol-docs/pro-roster/ProRosterTeams")),
  ...
  BroadcastLiveView: lazyWithRetry(() => import("@/pages/BroadcastLiveView")),
  AdminQuizReview: lazyWithRetry(() => import("@/pages/admin/AdminQuizReview")),
  QuizBuilderPro: lazyWithRetry(() => import("@/pages/admin/QuizBuilderPro")),
  AdminQuizWorkspace: lazyWithRetry(() => import("@/pages/admin/AdminQuizWorkspace")),
  AdminVideoExport: lazyWithRetry(() => import("@/pages/admin/AdminVideoExport")),
...
const PATH_TO_KEYS: Array<{ test: (p: string) => boolean; keys: (keyof typeof Routes)[] }> = [
  ...
  { test: (p) => p.startsWith("/admin/quiz-content"), keys: ["AdminQuizWorkspace", "QuizBuilderPro", "AdminQuizReview"] },
  { test: (p) => p === "/admin/quiz-builder" || p === "/admin/quiz-review", keys: ["AdminQuizWorkspace"] },
  { test: (p) => p === "/lol", keys: ["LolHub", "CombatLab", "Quiz", "LeagueSwipeHub"] },
  { test: (p) => p === "/league-swipe", keys: ["LeagueSwipeHub", "LeagueSwipeGame", "LeagueSwipeStats"] },
  { test: (p) => p === "/league-swipe/stats", keys: ["LeagueSwipeStats"] },
  { test: (p) => p.startsWith("/league-swipe/"), keys: ["LeagueSwipeGame"] },
  { test: (p) => p === "/lol/tier-list", keys: ["LolTierList"] },
  { test: (p) => p.startsWith("/items/"), keys: ["ItemDetail"] },
  { test: (p) => p === "/lol/docs", keys: ["LeagueDocsLanding", "LeagueDocsChampionIndex", "LeagueDocsChampionDetail", "LeagueDocsProData"] },
  { test: (p) => p.startsWith("/lol/docs/champions"), keys: ["LeagueDocsChampionIndex", "LeagueDocsChampionDetail"] },
  { test: (p) => p === "/lol/docs/pro", keys: ["LeagueDocsProData", "LeagueDocsProYear", "LeagueDocsProChampionIndex", "ProRosterLanding"] },
  { test: (p) => p === "/lol/docs/pro/rosters", keys: ["ProRosterLanding", "ProRosterPlayers", "ProRosterTeams"] },
  { test: (p) => p === "/lol/docs/pro/players", keys: ["ProRosterPlayers", "ProRosterPlayerProfile"] },
  { test: (p) => p.startsWith("/lol/docs/pro/players/"), keys: ["ProRosterPlayerProfile", "ProRosterTeamProfile"] },
  { test: (p) => p === "/lol/docs/pro/teams", keys: ["ProRosterTeams", "ProRosterTeamProfile"] },
  { test: (p) => p.startsWith("/lol/docs/pro/teams/"), keys: ["ProRosterTeamProfile", "ProRosterPlayerProfile"] },
  { test: (p) => p.startsWith("/lol/docs/pro/years"), keys: ["LeagueDocsProYear", "LeagueDocsProData"] },
