...
export const profileThemes: ProfileTheme[] = [
  ...
  },
  {
    ...
    label: "Light",
    isPro: false,
    preview: "bg-gradient-to-r from-[hsl(210,40%,96%)] to-[hsl(210,40%,98%)]",
    styles: {
      pageBg: "linear-gradient(180deg, hsl(209,40%,96%) 0%, hsl(210,40%,98%) 100%)",
      heroBg: "bg-gradient-to-b from-[hsl(210,80%,60%)/0.08] via-[hsl(210,40%,96%)/0.5] to-transparent",
      cardBg: "border-[hsl(212,26%,83%)/0.6] bg-[hsl(210,40%,98%)/0.9]",
      accentRing: "ring-[hsl(210,80%,60%)/0.3]",
      textAccent: "text-[hsl(210,80%,60%)]",
      iconAccent: "text-[hsl(210,80%,60%)]",
      statBg: "bg-[hsl(210,40%,98%)/0.8] border-[hsl(212,26%,83%)/0.5]",
      headingColor: "text-[hsl(222,47%,11%)]",
      nameColor: "text-[hsl(222,47%,11%)]",
      textColor: "text-[hsl(222,47%,11%)]",
      mutedColor: "text-[hsl(215,20%,45%)]",
      innerBg: "bg-[hsl(210,40%,96%)/0.7]",
      innerBorder: "border-[hsl(212,26%,83%)/0.5]",
    },
  },
  {
    id: "dark",
