...
const ROUTES: RouteSpec[] = [
  ...
  { path: "/admin/analytics", label: "Admin Analytics", group: "Admin", authed: true },
  { path: "/admin/play", label: "Admin Play Layout", group: "Admin", authed: true },
  { path: "/admin/arena/data-graphs", label: "Arena Data Graphs", group: "Admin", authed: true },
  ...
  { path: "/quiz/diagnostics", label: "Quiz API Inspector", group: "Admin", authed: true },
