...
function LeagueCard({
  ...
  const linkState = type === "preset" ? { from: "/swipe-leagues", openCategory: league.category } : undefined;
    ...
    <div className="min-h-screen bg-background px-4 py-8">
      <div className="container mx-auto max-w-2xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-3xl font-extrabold text-foreground flex-1">Swipe</h1>
        </div>
