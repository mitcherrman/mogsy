  ...
  },
  {
    ...
    settlement: mk(
      "r-charge-consumed",
      {
        ...
        xpAwarded: 20,
        xpAfter: 20,
        selectedAbility: { abilityId: "tank-starter", name: "Bulwark" },
        chargesBefore: 2,
        chargesConsumed: 1,
        chargesAfter: 1,
      },
  ...
  },
  {
    ...
    settlement: mk(
      "r-charge-kept",
      {
        ...
        xpAwarded: 20,
        xpAfter: 20,
        selectedAbility: { abilityId: "mm-l2-quickdraw", name: "Quickdraw" },
        chargesBefore: 1,
        chargesConsumed: 0,
        chargesAfter: 1,
      },
  ...
  },
  {
    ...
    settlement: mk(
      "r-carryover-created",
      {
        ...
        combatLabCarryover: {
          key: "stored_burn",
          summary: "Stored burn: 6 damage pending next settlement",
          status: "created",
        },
      },
      { baseIncomingDamage: 30, finalDamage: 30, hpAfter: 60 },
  ...
  },
  {
    ...
    settlement: mk(
      ...
      { answerOutcome: "correct", xpAwarded: 20, xpAfter: 20 },
      {
        ...
        combatLabCarryover: {
          key: "stored_burn",
          summary: "Stored burn consumed: +6 damage applied",
          status: "consumed",
        },
      },
    ),
