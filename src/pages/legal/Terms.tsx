  ...
  return (
    ...
    >
      <Section title="Eligibility">
        <p>
          You must be at least 13 years old to use Mogzy. By creating an
      ...
      <Section title="User responsibilities">
        <p>To keep Mogzy fair and welcoming, you agree not to engage in:</p>
        <Bullets
          items={[
      ...
      <Section title="Content you submit">
        <p>
          You are responsible for content you post on Mogzy, including
          comments, profile information, and submissions. You grant Mogzy a
      ...
      <Section title="Platform rights">
        <p>Mogzy reserves the right to:</p>
        <Bullets
          items={[
      ...
      <Section title="Fan content disclaimer">
        <p>
          Mogzy is an unofficial fan project. Mogzy isn't endorsed by Riot
          ...
          Inc. Game data and imagery referenced by Mogzy are used for
      ...
      <Section title="Disclaimer of warranties">
        <p>
          Mogzy is provided “as is” and “as available” without warranties of
      ...
      <Section title="Limitation of liability">
        <p>
          To the maximum extent permitted by law, Mogzy and its operators are
      ...
      <Section title="Changes to these terms">
        <p>
          We may update these terms from time to time. Continued use of Mogzy
