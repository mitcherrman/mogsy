...
export default function Security() {
  return (
    <LegalLayout
      ...
      path="/security"
      heading="Security at Mogsy"
      intro="We take reasonable measures to protect accounts, data, and the integrity of the platform. This page is maintained by the Mogsy team to answer common security questions."
      keywords="mogsy security, responsible disclosure, vulnerability reporting"
    >
      <Section title="Transport encryption">
        <p>
          All traffic to Mogsy is served over HTTPS using modern TLS. This
      ...
      <Section title="Authentication">
        <p>
          Mogsy uses well-established authentication providers for account
      ...
      <Section title="Responsible disclosure">
        <p>
          If you believe you’ve found a security vulnerability in Mogsy, we’d
      ...
      <Section title="Your role in security">
        <Bullets
          items={[
            "Use a strong, unique password for your Mogsy account",
