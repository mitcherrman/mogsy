                ...
                <div className="w-full portrait:aspect-[5/4] landscape:aspect-[3/4] md:aspect-[3/4] relative overflow-hidden">
                  ...
                  {phase === "stab" && (
                    <>
                      ...
                      />
                      <motion.div
                        className="absolute bottom-0 left-[30%] right-[30%] h-[40%] flex items-end justify-center z-10 overflow-hidden"
                      ...
                      >
                        <div className="relative w-full h-full overflow-hidden rounded-2xl"
                          style={{
                            maskImage: "radial-gradient(ellipse 70% 60% at center 60%, black 45%, transparent 90%)",
                            WebkitMaskImage: "radial-gradient(ellipse 70% 60% at center 60%, black 45%, transparent 90%)",
                          }}
                        >
                          <img
