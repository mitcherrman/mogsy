...
> a third Lab composition policy. Backend `c2634d8a` PUSHED to `origin/master`; Generator Lab only**).
...
**Current next task — pick ONE of the Slice-profile phase's next options, and do NOT wire Ranked.**
